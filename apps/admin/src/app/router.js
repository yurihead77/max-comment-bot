...
export function Router() {
    ...
    return (_jsxs("main", { className: "admin-shell", children: [_jsx("h1", { className: "admin-title", children: "Admin panel" }), _jsxs("div", { className: "admin-tabs", children: [_jsx("button", { onClick: () => setTab("comments"), children: "Comments" }), _jsx("button", { onClick: () => setTab("moderators"), children: "Moderators" }), _jsx("button", { onClick: () => setTab("restrictions"), children: "Restrictions" }), _jsx("button", { onClick: () => setTab("modlog"), children: "Moderation log" })] }), tab === "comments" && _jsx(CommentsTable, {}), tab === "moderators" && _jsx(ModeratorsPage, {}), tab === "restrictions" && _jsx(RestrictionsPage, {}), tab === "modlog" && _jsx(ModlogPage, {})] }));
}
