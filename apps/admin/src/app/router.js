...
export function Router() {
    ...
    return (_jsxs("main", { style: { padding: 16, display: "grid", gap: 12 }, children: [_jsx("h1", { children: "Admin panel" }), _jsxs("div", { style: { display: "flex", gap: 8 }, children: [_jsx("button", { onClick: () => setTab("comments"), children: "Comments" }), _jsx("button", { onClick: () => setTab("moderators"), children: "Moderators" }), _jsx("button", { onClick: () => setTab("restrictions"), children: "Restrictions" }), _jsx("button", { onClick: () => setTab("modlog"), children: "Moderation log" })] }), tab === "comments" && _jsx(CommentsTable, {}), tab === "moderators" && _jsx(ModeratorsPage, {}), tab === "restrictions" && _jsx(RestrictionsPage, {}), tab === "modlog" && _jsx(ModlogPage, {})] }));
}
